		...
		<div id="wrapper">
			...
			<%@include file="TabBar.jsp" %>
							...
							<div class="container-fluid">
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 class="m-0 font-weight-bold text-primary">เอกสารขาย / ใบวางบิล (Biiling)
										</h4>
									</div>
									<div class="card-body">
												...
												<div class="row" style="margin-bottom: 10px;">
													...
													<div class="col-sm-1">
														<button class="btn btn-primary" type="button"
															onclick="tableBiiling()"
															style="margin-top: 42px;width: 87px;"> ค้นหา <i
																class="fas fa-fw fa-search"></i></button>
													</div>
												</div>
												<table id="tableBiiling" class="table table-sm table-hover"
													width="100%">
								...
								<div class="row">
									...
									<div class="table-responsive col-sm-12" style="margin-top: 12px;">
										<div style="margin-left: 2%;width: 97%;">
											<div class="card">
												<div class="card-body">
													<table id="tableCreateBiilingDisplay"
				...
				<div id="MyModalPrintPDF" class="modal fade" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog modal-lg" style="max-width: 1100px;">
						<div class="modal-content">
							...
							<div>
								<%@include file="/WEB-INF/PrintPDF/PrintPDFF2M2.jsp" %>
							</div>
						</div>
					</div>
				</div>
				...
				<%@include file="/WEB-INF/Extensions/js.jsp" %>
					<script src="/data-table/F2M2BillingList.js" type="text/javascript"></script>
					<script src="/print-pdf-js/f2m2-print-pdf-Quotation.js" type="text/javascript"></script>
