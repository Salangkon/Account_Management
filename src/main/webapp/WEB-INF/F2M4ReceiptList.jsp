							...
							<div class="container-fluid">
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 class="m-0 font-weight-bold text-primary">เอกสารขาย / ใบเสร็จรับเงิน
											(Receipt)</h4>
									</div>
									<div class="card-body">
												...
												<div class="row" style="margin-bottom: 10px;">
													...
													<div class="col-sm-1">
														<button class="btn btn-primary" type="button"
															onclick="tableReceipt()"
															style="margin-top: 42px;width: 87px;"> ค้นหา <i
																class="fas fa-fw fa-search"></i></button>
													</div>
												</div>
												<table id="tableReceipt" class="table table-sm table-hover"
													width="100%">
					...
					<div class="modal-dialog modal-lg" style="max-width: 1400px;">
						<div class="modal-content">
							...
							<div class="modal-header">
								<h4 class="modal-title">สร้างใบเสร็จรับเงิน</h4>
