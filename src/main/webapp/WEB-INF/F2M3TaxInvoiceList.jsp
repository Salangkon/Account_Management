		...
		<div id="wrapper">
			...
			<%@include file="TabBar.jsp" %>
							...
							<div class="container-fluid">
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 class="m-0 font-weight-bold text-primary">เอกสารขาย / ใบกำกับภาษี (Tax
											Invoice)</h4>
									</div>
									<div class="card-body">
												...
												<div class="row" style="margin-bottom: 10px;">
													...
													<div class="col-sm-2">
														<select class="form-control" style="margin-top: 10px;"
															...
															<option value="2" style="color: green;">ดำเนินการเเล้ว
															</option>
												...
												<div class="row" style="margin-bottom: 10px;">
													...
													<div class="col-sm-1">
														<button class="btn btn-primary" type="button"
															onclick="tableTaxInvoice()"
															style="margin-top: 42px;width: 87px;"> ค้นหา <i
																class="fas fa-fw fa-search"></i></button>
													</div>
												</div>
												<table id="tableTaxInvoice" class="table table-sm table-hover"
													width="100%">
					...
					<div class="modal-dialog modal-lg" style="max-width: 1400px;">
						<div class="modal-content">
							...
							<div class="modal-header">
								...
								<h4 class="modal-title" id="receiptFlgTitle">สร้างใบเสร็จรับเงิน</h4>
							...
							<div class="modal-footer">
								...
								<button type="button" class="btn btn-success" onclick="saveCreateQuotationReceipt()"
									id="saveReceiptFlg">บันทึกใบเสร็จรับเงิน</button>
				...
				<%@include file="/WEB-INF/Extensions/js.jsp" %>
					<script src="/data-table/F2M3TaxInvoiceList.js" type="text/javascript"></script>
