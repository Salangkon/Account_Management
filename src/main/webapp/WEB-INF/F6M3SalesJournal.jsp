		...
		<div id="wrapper">
			...
			<%@include file="TabBar.jsp" %>
					...
					<div id="content">
						...
						<%@include file="Topbar.jsp" %>
							...
							<div class="container-fluid">
								<div class="row" style="margin-bottom: 10px;margin-left: 3px;">สมุดรายวัน /
									สมุดรายวันขาย</div>
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 class="m-0 font-weight-bold text-primary">สมุดรายวันขาย</h4>
									</div>
									<div class="card-body">
												...
												<div class="row">
													...
													<div class="col-sm-1">
														<button type="button" class="btn btn-primary"
															...
															onclick="createUpdate(null)">สร้างใหม่</button>
													</div>
												</div>
												<div class="row" style="margin-bottom: 10px;">
													<div class="col-sm-7"></div>
													<div class="col-sm-2"><label>เริ่มต้น : </label><input
															id="fromDate" /> </div>
													<div class="col-sm-2"><label>ถึง : </label><input id="toDate" />
													</div>
													<div class="col-sm-1">
														<button class="btn btn-primary" type="button"
															onclick="tableJournal()"
					...
					<div class="modal-dialog modal-lg" style="max-width: 1600px;">
						<div class="modal-content">
							...
							<div class="modal-header">
								<h4 class="modal-title">สมุดรายวันขาย</h4>
															...
															<div class="col-sm-8">
																...
																<!-- <select id="customers" class="selectpicker"
																	...
																	<% for (int i=0; i < customers.size(); i++) { %>
																		<option
																			value="<%=customers.get(i).getCompanyId()%>">
														...
														<table id="tablegeneraJournalDisplay"
															...
															<tfoot>
																<tr>
																	...
																	<th style="text-align: right;"><span hidden
																			class="invalid" id="invalid-sumDebitCredit">
				...
				<%@include file="/WEB-INF/Extensions/js.jsp" %>
					<script src="\data-table\F6M3SalesJournal.js" type="text/javascript"></script>
