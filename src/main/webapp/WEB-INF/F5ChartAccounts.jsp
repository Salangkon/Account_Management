								...
								<div class="table-responsive col-sm-12">
									...
									<div class="card o-hidden border-0 shadow-lg my-5" id="card">
										<div class="card-body p-0">
											...
											<div class="row">
												<div class="col-lg-6" style="background-color: linen">
												...
												<form class="user">
													<div class="form-group row">
														...
														<div class="col-sm-7 mb-3 mb-sm-0">
															<div>
																<label>ชื่อลูกค้า</label> <select class="form-control"
																	id="companyType"
															...
															<div>
																<label>เลขประจำตัวผู้เสียภาษี</label><input
																	...
																	id="taxId" placeholder="เลขประจำตัวผู้เสียภาษี">
															</div>
															<div>
																<label>สำนักงาน / สาขาที่ </label> <input type="radio"
																	name="">
														...
														<div class="col-sm-5">
															...
															<div>
																<label>ครบกำหนด</label> <select class="form-control"
																	id="companyType" placeholder="ครบกำหนด">
																	<option value="สมุดรายวันขาย">TEST 01</option>
																	<option value="สมุดรายวันซื้อ">TEST 01</option>
																</select>
															</div>
															<div>
																<label>เลขอ้างอิง</label><input class="form-control"
																	id="" placeholder="เลขอ้างอิง">
															</div>
															<div>
																<label>ราคาไม่รวมภาษี</label> <select
																	class="form-control" id="companyType"
