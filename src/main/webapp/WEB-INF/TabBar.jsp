...
<ul class="navbar-nav sidebar w3-light-grey accordion" id="accordionSidebar" style="background-color: silver;">
	...
	<!-- Sidebar - Brand -->
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/" style="background-color: purple;">
	...
	<!-- เอกสารขาย -->
	<li class="nav-item">
		<a class="nav-link collapsed icon-color" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
	...
	<li class="nav-item">
		<a class="nav-link collapsed icon-color" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
	...
	<!-- รายงานภาษี -->
	<li class="nav-item">
		<a class="nav-link collapsed icon-color" href="#" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="true"
