								...
								<td style="width: 100%;vertical-align: top">
									...
									<table class="table table-sm" id="tablePrintPDFDisplay" style="margin-top: 15px;">
										<tr>
											...
											<th style="width: 45%;text-align: center">รายละเอียด</th
												style="width: 100%;">
									...
									<div id="statusVatPrint1">
										<table style="width: 100%;margin-top: 15px;">
											<tr>
												<td style="width: 85%;text-align: right; color: orangered;">รวมเป็นเงิน
												</td>
										...
										<table style="width: 100%;">
											<tr>
												...
												<td style="width: 15%;text-align: right;"
													id="discountProductPricePrint">0</td>
											</tr>
										</table>
										<table style="width: 100%;">
											<tr>
										...
										<table style="width: 100%;">
											<tr>
												...
												<td style="width: 15%;text-align: right;" id="productPriceAllPrint">0
												</td>
											</tr>
										</table>
										<table>
									...
									<div id="statusVatPrint2">
										...
										<table style="width: 100%;">
											<tr>
												...
												<td style="width: 15%;text-align: right;" id="discountPricePrint1">0
												</td>
											</tr>
										</table>
										<table style="width: 100%;">
											<tr>
												...
												<td>
												<td style="width: 15%;text-align: right;"
													id="discountProductPricePrint1">0</td>
											</tr>
										</table>
										...
										<table style="width: 100%;">
											<tr>
												<td style="width: 85%;text-align: right; color: orangered;">
													ราคาไม่รวมภาษี</td>
												<td style="width: 15%;text-align: right;" id="productPriceAllPrint1">0
												</td>
											</tr>
										</table>
										<table style="width: 100%;">
									...
									<table id="noteFlg">
										<tr>
											<td style="width: 50%;"><label style="color: orangered;">หมายเหตุ</label>
											</td>
