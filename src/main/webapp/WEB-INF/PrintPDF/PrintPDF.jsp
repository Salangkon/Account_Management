...
<div id="printThis">
	<div>
		...
		<table style="width: 100%;">
			<tr>
				<th style="width: 50%; color: purple;">ลูกค้า</th>
		...
		<table style="width: 100%;">
			<tr>
				<td style="width: 85%;text-align: right;">รวมเป็นเงิน</td>
				<td style="width: 15%;text-align: right;" id="priceDisplayPrint">0</td>
			</tr>
		</table>
		<table style="width: 100%;">
			<tr>
				<td style="width: 85%;text-align: right;">ส่วนลด</td>
				<td style="width: 15%;text-align: right;" id="discountPrint">0</td>
			</tr>
		</table>
		<table style="width: 100%;">
			<tr>
				<td style="width: 85%;text-align: right;">จำนวนเงินหลังหักส่วนลด<td>
				<td style="width: 15%;text-align: right;" id="discountPricePrint">0</td>
			</tr>
		</table>
		<table style="width: 100%;">
			<tr>
				<td style="width: 85%;text-align: right;">ภาษีมูลค่าเพิ่ม 7%<td>
				<td style="width: 15%;text-align: right;" id="vatPrint">0</td>
			</tr>
		</table>
		<table style="width: 100%;">
			<tr>
				<td style="width: 85%;text-align: right;">จำนวนเงินทั้งสิ้น</td>
		...
		<table>
			<tr>
				<td style="max-width: 50%;"><label>หมายเหตุ <br>
						ตัวอย่าง หมายเหตุ
					</label></td>
