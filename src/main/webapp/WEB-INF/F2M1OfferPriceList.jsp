				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h4 class="m-0 font-weight-bold text-primary">เอกสารขาย /
								ใบเสนอราคา (Quotation)</h4>
						</div>
						<div class="card-body">
							<div class="table-responsive col-sm-12">
								<div class="table-responsive col-sm-12">
									...
									<div class="row" style="margin-bottom: 10px;">
										...
										<div class="col-sm-2">
											<label>เริ่มต้น : </label><input id="fromDate" value="" />
										</div>
										<div class="col-sm-2">
			...
			<div class="modal-dialog modal-lg" style="max-width: 1400px;">
				<div class="modal-content">
					...
					<div class="modal-header">
						<h4 class="modal-title" id="quotationTitle">สร้างใบเสนอราคา</h4>
						<h4 class="modal-title" id="biilingFlgTitle">สร้างใบวางบิล</h4>
						<h4 class="modal-title" id="taxInvoiceFlgTitle">สร้างใบกำกับภาษี</h4>
							...
							<div class="col-lg-4">
								<div class="p-3">
									<div class="form-group row">
										...
										<div class="col-sm-8">
											<input id="date" />
											<p class="hide" id="error-date">กรุณาเลือก วันที่</p>
										</div>
										<div class="col-sm-4">
										...
										<div class="col-sm-8" style="margin-top: 10px;">
											<input id="dateEnd" />
											<p class="hide" id="error-dateEnd">กรุณาเลือก ครบกำหนด</p>
										</div>
										<div class="col-sm-4">
										...
										<div class="col-sm-4">
											<label style="margin-top: 50px; color: red;"><b>ราคาสินค้า</b></label>
										</div>
										<div class="col-sm-8">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-success"
							onclick="saveCreateQuotation()" id="saveQuotationFlg">บันทึก</button>
						<button type="button" class="btn btn-success"
							onclick="saveCreateQuotationBilling()" id="saveBiilingFlg">สร้างใบวางบิล</button>
						<button type="button" class="btn btn-success"
							onclick="saveCreateQuotationTaxInvoice()" id="taxInvoiceFlg">สร้างใบกำกับภาษี</button>
