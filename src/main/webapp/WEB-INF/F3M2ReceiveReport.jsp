							...
							<div class="container-fluid">
								...
								<div class="card shadow mb-4">
									<div class="card-header py-3">
										<h4 class="m-0 font-weight-bold text-primary">เอกสารซื้อ / ใบรับสินค้า (Receive
											Report)</h4>
									</div>
									<div class="card-body">
												...
												<div class="row" style="margin-bottom: 10px;">
													...
													<div class="col-sm-2">
														<select class="form-control" style="margin-top: 10px;"
															...
															<option value="2" style="color: green;">ชำระเงินเเล้ว
															</option>
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-success" onclick="saveCreateQuotation()"
									id="receiveReportFlg">บันทึก</button>
