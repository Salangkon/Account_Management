										...
										<div class="p-3">
											<div class="form-group row">
												...
												<div class="col-sm-8">
													...
													<p class="hide" id="error-taxId" style="color: red;">กรุณากรอก
														เลขประจำตัวผู้เสียภาษี</p>
													<p class="hide" id="error-taxId-length" style="color: red;">
														กรุณากรอก
												...
												<div class="col-sm-8">
													<div>
														<input type="radio" name="officeType" id="department1"
															onclick="CheckOffice(1)" value="1" style="margin-left: 10px"
															checked>
														สำนักงานใหญ่
														<input type="radio" name="officeType" id="department2"
															onclick="CheckOffice(2)" value="2"
															style="margin-left: 10px"> สาขาที่
													</div>
													<div id="department">
														<div class="input-group input-group-sm mb-3">
															<input type="text" class="form-control"
																aria-describedby="inputGroup-sizing-sm"
																id="departmentPass" placeholder="รหัสสาขา">
															<input type="text" class="form-control"
																aria-describedby="inputGroup-sizing-sm"
																id="departmentName" placeholder="ชื่อสาขา">
														</div>
												...
												<div class="col-sm-8">
													<input type="text" OnKeyPress="return chkNumber(this)"
												...
												<div class=" col-sm-8">
													...
													<input id="singleFileUploadInput" type="file" name="img[]"
